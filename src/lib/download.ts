...
export async function downloadVideo(
  ...
  const info = await withTimeout(
    ytdlp.getInfoAsync(url) as Promise<YtDlpVideoInfo>,
    YTDLP_INFO_TIMEOUT_MS,
    `ytdlp.getInfoAsync(${videoId})`
  );
